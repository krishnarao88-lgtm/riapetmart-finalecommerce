...
export function WelcomePopup() {
  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-center bg-choc/50 p-4">
      <div className="relative w-full max-w-sm rounded-3xl border-2 border-choc bg-cream p-6 shadow-[6px_6px_0_0_var(--color-choc)]">
        <button
          type="button"
          onClick={dismiss}
          aria-label="Close"
        ...
        <h2 className="mt-3 font-bubble text-2xl font-extrabold text-choc">Get 10% off</h2>
